...
class DirectoriosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create directorio" do
    assert_difference('Directorio.count') do
      post directorios_url, params: { directorio: { apellido: @directorio.apellido, direccion: @directorio.direccion, nombre: @directorio.nombre, telefono: @directorio.telefono } }
    end
  ...
  test "should update directorio" do
    patch directorio_url(@directorio), params: { directorio: { apellido: @directorio.apellido, direccion: @directorio.direccion, nombre: @directorio.nombre, telefono: @directorio.telefono } }
